...
//------------------------------------------------------------------------------------------------------
- (void)initController {
    maIntroTitles   = [[NSMutableArray alloc] initWithObjects: @"Estos son..", @"Los personajes de..", @"", nil];
    
    maIntroImgs     = [[NSMutableArray alloc] initWithObjects: @"seattle.jpg", @"legend.jpg", @"tittle.png", nil];
